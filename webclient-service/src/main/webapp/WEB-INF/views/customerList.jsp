...
<body>
	...
	<div class="container">
		...
		<div class="row">
			<h1>Show Customer Details using ID</h1>
			<ul>
				<c:forEach items="${customers}" var="customer">
					<li><a href="/api/webclient/customerDetails?id=${customer.id}">${customer.id}</a></li>
		...
		<div class="row">
			<h1>Customer Details using AADHAR</h1>
			<ul>
				<c:forEach items="${customers}" var="customer">
					<li><a href="/api/webclient/customerDetails/aadhar?aadhar=${customer.aadhar}">${customer.aadhar}</a></li>
				</c:forEach>
			</ul>
		</div>
